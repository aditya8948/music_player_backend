...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for user signup with OTP verification")
public class SignupRequest {

    @NotBlank(message = "Name is required")
    @Size(min = 2, max = 50, message = "Name must be between 2 and 50 characters")
    @Schema(description = "User's full name", example = "Aditya Pandey", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
